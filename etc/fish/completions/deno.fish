...
Docs: https://deno.land/manual@v1.33.0/basics/permissions
Examples:
  --allow-read
...
https://deno.land/manual@v1.33.0/basics/permissions
'
...
complete -c deno -n "__fish_seen_subcommand_from check" -l node-modules-dir -d 'Creates a local node_modules folder' -r -f -a "{true	,false	}"
...
complete -c deno -n "__fish_seen_subcommand_from info" -l node-modules-dir -d 'Creates a local node_modules folder' -r -f -a "{true	,false	}"
